...
},
{
  ...
  "overview": "Un grupo de mercenarios decide llevar a cabo el mayor atraco que jamás se haya realizado en la ciudad de Las Vegas justo después de que se produzca una epidemia de muertos vivientes. Para ello tendrán que adentrarse en una zona de cuarentena, con los riesgos que ello conlleva.",
  "popularity": 3307.832,
...
},
{
  ...
  "overview": "Una implacable inspectora encuentra afinidades con un asesino que mata a los criminales que dirigen una poderosa red de tráfico de menores.",
  "popularity": 1837.375,
...
},
{
  ...
  "overview": "Un adolescente testigo de un asesinato es perseguido por dos asesinos gemelos a través de las tierras salvajes de Montana. Aunque cuenta con un experto de la supervivencia para evitar que los secuaces le den caza, un incendio cercano pronto amenaza con robar la vida de todos los implicados.",
  "popularity": 1481.61,
...
},
{
  ...
  "overview": "Un ex Navy SEAL convertido en agente de la CIA busca venganza después de que su novia es asesinada por un narcotraficante de Baltimore.",
  "popularity": 1559.41,
...
},
{
  ...
  "overview": "Antes de crear un emporio de la droga, Ferry Bouman vuelve a su ciudad para vengarse. Allí se pondrá a prueba su lealtad y el amor le cambiará la vida.",
  "popularity": 1139.354,
...
},
{
  ...
  "original_title": "서복",
  "overview": "Ki Hun es un ex agente de la agencia de inteligencia. Seo Bok es el primer clon humano y posee el secreto para la vida eterna. Ki Hun se involucra en situaciones peligrosas debido a varias fuerzas que quieren tomar posesión de Seo Bok.",
  "popularity": 1048.489,
...
},
{
  ...
  "overview": "The Banishing cuenta la historia de la casa más encantada de Inglaterra. En la década de 1930, un joven reverendo, su esposa y su hija se mudan a una mansión con un secreto espantoso.",
  "popularity": 951.967,
...
// Función que imprime los nombres de todas las peliculas
...
// imprimir peliculas por idioma, el campo es original language
const imprimirPeliculasPorIdiomas = (idioma) => {

}


// imprimir la pelicula con la mayor cantidad de votos, campo vote_count
const peliculaConMayorCantidadDeVotos = () => {

}


// Imprimir una o más peliculas dada una  fecha de lanzamiento
const peliculaPorFechaDeLanzamiento = () => {

}


// Imprimir peliculas con mayor cantidad de géneros, campo genre_ids 
const peliculasConMayorCantidadDeGeneros = () => {
  let cantGeneros = 0;
  // Calcular la mayor cantidad de géneros
  for (let i = 0; i < peliculas.length; i++) {
    if (peliculas[i].genre_ids.length > cantGeneros) {
      cantGeneros = peliculas[i].genre_ids.length;
    }
  }
  console.log(cantGeneros);
